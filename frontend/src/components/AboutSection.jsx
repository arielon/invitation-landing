		...
		<AnimatedComponent animation={fadeIn} delay={0.2}>
			<div className="about-us-story">
				<p>
					...
					hablábamos, si en ese momento nos hubiesen dicho que nos casaríamos definitivamente nos reiríamos y no lo
					creríamos pero el universo ya había conspirado a nuestro favor y volvió a cruzar nuestros caminos. Y si, ahí
					se convirtió en amor a última y a todas las vistas; encontramos nuestro lugar seguro y mágico, ese donde
